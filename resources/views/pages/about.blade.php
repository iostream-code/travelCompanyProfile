...
@section('content')
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="text-center fade-in-up">
                ...
                <p class="text-xl text-gray-600 mb-8 leading-relaxed max-w-3xl mx-auto">
                    Kami adalah platform terpadu yang dirancang untuk memberdayakan bisnis dengan teknologi inovatif dan
                    solusi yang mudah digunakan.
                </p>
            </div>
        </div>
    </section>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center scroll-reveal">
                <div>
                    ...
                    <h2 class="text-4xl font-bold text-gray-800 mb-4">Memberdayakan Bisnis untuk Masa Depan</h2>
                    <p class="text-gray-600 mb-6 text-lg leading-relaxed">
                        Di MyApp, kami percaya bahwa teknologi harus mempermudah, bukan mempersulit. Misi kami adalah
                        menyediakan platform yang intuitif dan kuat untuk membantu bisnis dari berbagai skala mencapai
                        potensi maksimal mereka.
                    </p>
                    <ul class="space-y-4">
                        <li class="flex items-start group">
                            <span class="text-orange-600 mr-4 text-2xl group-hover:scale-125 transition-transform">✓</span>
                            <span class="text-gray-700 text-lg">Menyederhanakan proses bisnis</span>
                        </li>
                        <li class="flex items-start group">
                            <span class="text-orange-600 mr-4 text-2xl group-hover:scale-125 transition-transform">✓</span>
                            <span class="text-gray-700 text-lg">Meningkatkan efisiensi operasional</span>
                        </li>
                        <li class="flex items-start group">
                            <span class="text-orange-600 mr-4 text-2xl group-hover:scale-125 transition-transform">✓</span>
                            <span class="text-gray-700 text-lg">Memberikan wawasan berbasis data</span>
                        </li>
                    </ul>
                </div>
                <div>
                    <div class="relative group">
                        ...
                        <img src="https://via.placeholder.com/500x400" alt="Mission Illustration"
    ...
    <section class="py-20 bg-gradient-to-b from-white to-gray-50 relative">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16 fade-in-up">
                <h2 class="text-5xl font-bold text-gray-800 mb-4">Tim Kami</h2>
                <p class="text-xl text-gray-600">Kenali tim di balik kesuksesan MyApp</p>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 scroll-reveal">
                <div
                    class="team-card group bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 border border-orange-100 hover:border-orange-300 transform hover:-translate-y-2">
                    <div
                    ...
                    <p class="text-gray-600 leading-relaxed">Andi memimpin visi MyApp dengan pengalaman lebih dari 15 tahun
                        di industri teknologi.</p>
                </div>
                <div
                    class="team-card group bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 border border-orange-100 hover:border-orange-300 transform hover:-translate-y-2">
                    <div
                    ...
                    <h3 class="text-xl font-bold text-gray-800 mb-2">Sari Lestari</h3>
                    <p class="text-gray-600 mb-4">CTO</p>
                    <p class="text-gray-600 leading-relaxed">Sari mengawasi pengembangan teknologi MyApp, memastikan
                        platform kami selalu inovatif.</p>
                </div>
                <div
                    class="team-card group bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 border border-orange-100 hover:border-orange-300 transform hover:-translate-y-2">
                    <div
                    ...
                    <h3 class="text-xl font-bold text-gray-800 mb-2">Rina Wijaya</h3>
                    <p class="text-gray-600 mb-4">Head of Customer Success</p>
                    <p class="text-gray-600 leading-relaxed">Rina memastikan setiap pelanggan mendapatkan pengalaman terbaik
                        dengan MyApp.</p>
                </div>
            </div>
        </div>
    ...
    <section class="py-20 bg-white relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="text-center mb-16 fade-in-up">
                ...
                <p class="text-xl text-gray-600">Prinsip yang mendorong kami untuk memberikan yang terbaik</p>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 scroll-reveal">
                <div
                ...
                <div
                    class="value-card group bg-gradient-to-br from-white to-orange-50 p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 border-l-4 border-orange-600 cursor-pointer transform hover:-translate-y-2">
                    <div class="text-5xl mb-4 group-hover:scale-110 transition-transform duration-500">🤝</div>
                    <h3 class="text-2xl font-bold text-gray-800 mb-3">Kolaborasi</h3>
                    <p class="text-gray-700 leading-relaxed">Kami bekerja bersama pelanggan untuk mencapai kesuksesan
                        bersama.</p>
                </div>
                <div
                    class="value-card group bg-gradient-to-br from-white to-orange-50 p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 border-l-4 border-orange-600 cursor-pointer transform hover:-translate-y-2">
                    <div class="text-5xl mb-4 group-hover:scale-110 transition-transform duration-500">🌟</div>
                    <h3 class="text-2xl font-bold text-gray-800 mb-3">Keunggulan</h3>
    ...
    <section class="relative bg-gradient-to-r from-orange-600 to-orange-700 text-white py-20 overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            <h2 class="text-5xl font-bold mb-6 fade-in-up">Bergabunglah dengan MyApp</h2>
            <p class="text-2xl mb-10 text-orange-100 fade-in-up delay-1">
                Mulai transformasi bisnis Anda dengan platform kami yang inovatif.
            </p>
            <a href="#"
